...
./mvnw package
```
It produces the `example-1.0.0-SNAPSHOT-runner.jar` file in the `/target` directory.
...
The application is now runnable using `java -jar target/example-1.0.0-SNAPSHOT-runner.jar`.
